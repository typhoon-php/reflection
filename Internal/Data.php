...
enum Data
{
    ...
    public const Interfaces = Data\Interfaces::Key;
    public const Parents = Data\Parents::Key;
    public const ThrowsType = Data\ThrowsType::Key;
    public const AliasType = Data\AliasType::Key;
    public const TraitMethodAliases = Data\TraitMethodAliases::Key;
    public const TraitMethodPrecedence = Data\TraitMethodPrecedence::Key;
